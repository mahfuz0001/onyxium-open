  ...
  return (
    <section className="py-12 justify-center">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-5 py-16 md:px-10 md:py-20">
        <p className="font-inter mb-2 text-center text-base font-medium text-purple-600">
          3 EASY STEPS
        </p>
        <h1 className="text-center text-4xl font-bold lg:text-4xl">
          How Onyxium AI Works
        </h1>
        <p className="font-inter mx-auto mb-12 mt-4 max-w-lg px-5 text-center text-base font-light text-gray-500">
          Discover how to get the most out of Onyxium AI in just a few simple
          steps.
        </p>
        <div className="flex flex-col items-start justify-center lg:flex-row">
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              ...
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                Create your account and explore the diverse range of AI models
                available on Onyxium AI. Find the tools that fit your needs,
          ...
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              ...
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                Choose the AI model that suits your task. Customize its
                parameters to get the best results, whether you're generating
                text, analyzing sentiment, or creating images.
              </p>
            </div>
            {/* MOBILE - HOW IT WORKS LINE */}
            <svg
          ...
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              ...
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                Run your customized AI models and get the results you need.
                Onyxium AI makes it easy to integrate these results into your
