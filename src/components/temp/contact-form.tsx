    ...
    <Container className="py-40 md:py-60 grid grid-cols-1 md:grid-cols-2 gap-10 px-6">
      <div>
        ...
        <div className="text-sm mt-10">
          ...
          <p className="text-sm text-neutral-400">contact@nexonlabs.uk</p>
        </div>
        ...
        <div className="text-sm mt-4">
          ...
          <p className="text-sm text-neutral-400">support@nexonlabs.uk</p>
        </div>
      </div>
      <div className="flex flex-col items-start gap-4 max-w-2xl w-full mx-auto bg-gradient-to-b from-neutral-900 to-neutral-950 p-10 rounded-3xl relative overflow-hidden">
        ...
        <div className="mb-4 w-full relative z-20">
          ...
          <input
            ...
            className="h-10 pl-4 w-full rounded-md text-sm bg-[#08090A] border border-neutral-800 text-white placeholder-neutral-500 outline-none focus:outline-none active:outline-none focus:ring-2 focus:ring-neutral-800"
          />
        </div>
        <div className="mb-4 w-full relative z-20">
          <label
        ...
        <div className="mb-4 w-full relative z-20">
          ...
          <textarea
            ...
            className="pl-4 pt-4 w-full rounded-md text-sm bg-[#08090A] border border-neutral-800 text-white placeholder-neutral-500 outline-none focus:outline-none active:outline-none focus:ring-2 focus:ring-neutral-800"
          />
        </div>
        <Button variant="neutral-200">Submit</Button>
      </div>
    </Container>
  );
};
