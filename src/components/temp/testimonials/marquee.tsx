  ...
  return (
    <div className="relative pb-40">
      ...
      <div className="relative">
        <div className="h-full w-10 md:w-80 absolute left-0 inset-y-0 bg-gradient-to-r from-[#08090A] to-transparent pointer-events-none z-40"></div>
        <div className="h-full w-10 md:w-80 absolute right-0 inset-y-0 bg-gradient-to-l from-[#08090A] to-transparent pointer-events-none z-40"></div>
