...
export const SkeletonFour = () => {
  return (
    <div className="p-8 overflow-hidden h-full relative flex flex-col group">
      ...
      <Container className="mt-10 ml-4">Image Generation</Container>
      <Container className="mt-4 ml-10 group-hover:border-[#80ED99] transition duration-200 group-hover:scale-[1.02]">
        Text Generation
      </Container>
      <Container className="mt-4 ml-4">Audio Generation</Container>
      <Cursor
        className="top-20 left-40 group-hover:left-32"
        textClassName="group-hover:text-[#80ED99]"
      />
      <Cursor
